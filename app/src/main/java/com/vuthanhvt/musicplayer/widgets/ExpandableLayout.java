...
import static com.vuthanhvt.musicplayer.widgets.ExpandableLayout.State.COLLAPSED;
import static com.vuthanhvt.musicplayer.widgets.ExpandableLayout.State.COLLAPSING;
import static com.vuthanhvt.musicplayer.widgets.ExpandableLayout.State.EXPANDED;
import static com.vuthanhvt.musicplayer.widgets.ExpandableLayout.State.EXPANDING;
...
public class ExpandableLayout extends FrameLayout {
    ...
    public ExpandableLayout(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            parallax = a.getFloat(R.styleable.ExpandableLayout_el_parallax, 1.2F);
            a.recycle();
//            setParallax(parallax);
    ...
    public interface OnExpansionUpdateListener {
         ...
         *
         * @param expansionFraction Value between 0 (collapsed) and 1 (expanded) representing the
